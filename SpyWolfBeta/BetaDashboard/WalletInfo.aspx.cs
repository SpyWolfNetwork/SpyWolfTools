...
namespace SpyWolfBeta.BetaDashboard {
    public partial class WalletInfo : System.Web.UI.Page {
        ...
        protected void GetData() {
            var x = BSCCallAPIWalletInfo.makeAPICallToken(txtAddress.Text.Trim());
    ...
    public class BSCCallAPIWalletInfo {
        ...
        public static string makeAPICallToken(string address) {
            ...
            queryString["action"] = "addresstokenbalance";
        ...
        public static string makeAPICallBNBBalanceNotWorking(string address) {
            ServicePointManager.Expect100Continue = true;
            ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls12;
            var URL = new UriBuilder("https://eu.bsc.chaingateway.io/v1/getTokenBalance");
            //var URL = new UriBuilder("https://sandbox-api.coinmarketcap.com/v1/cryptocurrency/listings/latest");

            var queryString = HttpUtility.ParseQueryString(string.Empty);
            //queryString["contractaddress"] = "account";
            queryString["binancecoinaddress"] = address;
            queryString["contractaddress"] = "0xc2d0f6b7513994a1ba86cef3aac181a371a4ca0c";
            queryString["apikey"] = "q9PdaWuD4j6DK6vsUgehhL8pgarSrS9m";
            //queryString["listing_status"] = "untracked";
