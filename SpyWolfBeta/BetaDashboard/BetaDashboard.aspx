<%@ Page Title="" Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeBehind="BetaDashboard.aspx.cs" Inherits="SpyWolfBeta.BetaDashboard.BetaDashboard" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="PageToolbar" runat="server">
</asp:Content>
<asp:Content ID="Content5" ContentPlaceHolderID="PageContent" runat="server">
    <h3 style="padding-left:20px">Track Wallet</h3>
    <table style="width:700px;padding-left:20px">
        <tr style="padding-bottom:10px; ">
            <td style="width:80px">
                Address : 
            </td><td style="width:410px">
       ...
       <tr>
            <td style="width:80px">
                BNB : 
            </td><td style="width:410px;padding-top:10px">
    ...
    <dx:ASPxGridView ID="grid" runat="server" AutoGenerateColumns="False" ClientInstanceName="grid" KeyFieldName="Id" Width="100%" OnHtmlDataCellPrepared="ASPxGridView1_HtmlDataCellPrepared"  OnCellEditorInitialize="grid_CellEditorInitialize">
        ...
        <Columns>
            ...
            <dx:GridViewDataColumn Caption="From" VisibleIndex="1" Width="100">
                <DataItemTemplate>
                    <table class="categoryTable">
                        <tr>
                            <td class="textCell" style="width: 33%">
            ...
            <dx:GridViewDataTextColumn FieldName="value1" Caption="value" VisibleIndex="3"></dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="gas" VisibleIndex="3"></dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="gasPrice" VisibleIndex="3"></dx:GridViewDataTextColumn>
