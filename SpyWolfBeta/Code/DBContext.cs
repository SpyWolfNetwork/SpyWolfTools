...
namespace SpyWolfBeta.Model {
    ...
    public class AppointmentDataSourceHelper {
        ...
        private static List<SchedulerAppointment> GenerateAppointments() {
            ...
            for(int i = -100; i < 100; i++) {
                ...
                SchedulerAppointment appointment = new SchedulerAppointment();
                appointment.Id = uniqueID;
                appointment.Subject = "Project Release " + uniqueID.ToString();
    ...
    public static class ResourceDataSourceHelper {
        ...
        static ResourceDataSourceHelper() {
            ...
            items.Add(new SchedulerResource { Id = 1, Name = "New Recruit" });
            items.Add(new SchedulerResource { Id = 2, Name = "Spy Tier 1" });
            items.Add(new SchedulerResource { Id = 3, Name = "Spy Tier 2" });
            items.Add(new SchedulerResource { Id = 4, Name = "Master Spy" });
            items.Add(new SchedulerResource { Id = 5, Name = "VIP I" });
            items.Add(new SchedulerResource { Id = 6, Name = "VIP II" });
            items.Add(new SchedulerResource { Id = 7, Name = "VIP III" });
            items.Add(new SchedulerResource { Id = 8, Name = "Spywolf Team" });
        }
